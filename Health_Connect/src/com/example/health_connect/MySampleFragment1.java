...
//		EditText e_eid = (EditText) findViewById(R.id.editText2);
		final EditText e_nat = (EditText) mView.findViewById(R.id.startdate);
		final EditText e_dob = (EditText) mView.findViewById(R.id.lic);
		final EditText e_w = (EditText) mView.findViewById(R.id.school);
		final EditText e_h = (EditText) mView.findViewById(R.id.degree);
